...
public class PedidoController {
    ...
    @PatchMapping("{id}")
    @ResponseStatus(HttpStatus.CREATED)
    public Integer update(@RequestBody PedidoDTO pedido, @PathVariable Integer id) {
        Pedido referencia = service.obterPedidoCompleto(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Pedido não encontrado."));
        Pedido _pedido = service.atualizar(pedido, referencia);
